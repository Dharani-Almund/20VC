...
# Go up to the project root directory if needed
...
def create_app() -> FastAPI:
    ...
    # Include API routes
    app.include_router(admin_router, prefix="/20VC-admin", tags=["20VC-admin"])
    app.include_router(user_router, prefix="/20VC-user", tags=["/20VC-user"])
