...
class PodcastTranscriber:
    ...
    def __init__(self, model_size: str = 'base', device: str = None):
        ...
        Args:
            ...
            device (str): Device to use ('cpu', 'cuda', 'mps', or None for auto-detection)
        """
        models = {
        ...
        self.whisper_model = WhisperForConditionalGeneration.from_pretrained(model_path).to(self.device)

    def _get_cached_transcript(self, audio_path: str, language: str, task: str) -> Optional[Dict]:
        ...
        if os.path.exists(transcript_path):
            ...
            # Get audio duration
            waveform, sr = librosa.load(audio_path, sr=16000, duration=1.0)  # Just load a small sample for duration
            ...
            return {
                ...
                'cached': True,
                'cache_date': datetime.fromtimestamp(mod_time).isoformat()
            }
